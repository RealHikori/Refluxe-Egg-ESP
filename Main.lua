...
loadAgeBtn.Text = "🕒 Load Pet Mutation Reroller"
...
loadAgeBtn.MouseButton1Click:Connect(function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/RealHikori/No-Lag-HUB/refs/heads/main/Main.lua"))()
end)
...
credit.Text = "Made By - RefluxeScripts"
